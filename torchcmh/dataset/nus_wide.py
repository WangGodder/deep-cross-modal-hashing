...
default_img_mat_url = os.path.join(abs_dir, "data", "nus wide", "imgList21.mat")
default_tag_mat_url = os.path.join(abs_dir, "data", "nus wide", "tagList21.mat")
default_label_mat_url = os.path.join(abs_dir, "data", "nus wide", "labelList21.mat")
default_seed = 7
...
__all__ = ['get_single_datasets', 'get_pairwise_datasets', 'get_triplet_datasets', 'get_triplet_ranking_datasets', 'get_quadruplet_datasets']
